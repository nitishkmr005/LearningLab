...
1. [The Problem: Meaning Lives in High-Dimensional Space](#1-the-problem-meaning-lives-in-high-dimensional-space)
2. [A Brief History: From Counting to Contextual Understanding](#2-a-brief-history-from-counting-to-contextual-understanding)
   - 2.1 [The Counting Era (pre-2013)](#21-the-counting-era-pre-2013)
   - 2.2 [Word2Vec: Learning from Co-occurrence (2013)](#22-word2vec-learning-from-co-occurrence-2013)
   - 2.3 [GloVe and FastText: Filling the Gaps (2014–2017)](#23-glove-and-fasttext-filling-the-gaps-20142017)
   - 2.4 [ELMo: Context Finally Enters (2018)](#24-elmo-context-finally-enters-2018)
   - 2.5 [BERT: The Foundation Model (2018)](#25-bert-the-foundation-model-2018)
3. [The Sentence Embedding Problem and the SBERT Breakthrough](#3-the-sentence-embedding-problem-and-the-sbert-breakthrough)
   - 3.1 [Why BERT's [CLS] Token Fails](#31-why-berts-cls-token-fails)
   - 3.2 [SBERT: Siamese Networks to the Rescue (2019)](#32-sbert-siamese-networks-to-the-rescue-2019)
4. [What Training an Embedding Model Actually Means](#4-what-training-an-embedding-model-actually-means)
5. [Dataset Preparation](#5-dataset-preparation)
   - 5.1 [Scored Pairs `(text_a, text_b, score)`](#51-scored-pairs-text_a-text_b-score)
   - 5.2 [Positive Pairs `(anchor, positive)`](#52-positive-pairs-anchor-positive)
   - 5.3 [Triplets `(anchor, positive, negative)`](#53-triplets-anchor-positive-negative)
   - 5.4 [Hard Negative Mining](#54-hard-negative-mining)
   - 5.5 [Synthetic Data Generation](#55-synthetic-data-generation)
   - 5.6 [Multi-Dataset Training](#56-multi-dataset-training)
6. [Loss Functions: The Evolution](#6-loss-functions-the-evolution)
   - 6.1 [Generation 1 — Softmax Classification Loss](#61-generation-1--softmax-classification-loss)
   - 6.2 [Generation 2 — Cosine Similarity Loss (Regression)](#62-generation-2--cosine-similarity-loss-regression)
   - 6.3 [Generation 3 — Contrastive Loss](#63-generation-3--contrastive-loss)
   - 6.4 [Generation 4 — Triplet Loss](#64-generation-4--triplet-loss)
   - 6.5 [Generation 5 — MultipleNegativesRankingLoss ⭐ (Modern Standard)](#65-generation-5--multiplenegativesrankingloss--modern-standard)
   - 6.6 [Generation 6 — CoSENTLoss and AnglELoss](#66-generation-6--cosentloss-and-angleloss)
   - 6.7 [Generation 7 — MatryoshkaLoss (Flexible Dimensions)](#67-generation-7--matryoshkaloss-flexible-dimensions)
   - 6.8 [Generation 8 — GISTEmbedLoss (Guide Model Filtering)](#68-generation-8--gistembedloss-guide-model-filtering)
   - [Summary: Complete Loss Function Reference](#summary-complete-loss-function-reference)
7. [Training Script](#7-training-script)
8. [Evaluation on Sample Data](#8-evaluation-on-sample-data)
   - 8.1 [Semantic Similarity Evaluator (for STS-style tasks)](#81-semantic-similarity-evaluator-for-sts-style-tasks)
   - 8.2 [Information Retrieval Evaluator (for search/RAG tasks)](#82-information-retrieval-evaluator-for-searchrag-tasks)
   - 8.3 [Triplet Evaluator](#83-triplet-evaluator)
   - 8.4 [Additional Evaluators: Complete Reference](#84-additional-evaluators-complete-reference)
   - 8.5 [Quick Sanity Check](#85-quick-sanity-check)
9. [Inferencing](#9-inferencing)
   - 9.1 [Basic Encoding](#91-basic-encoding)
   - 9.2 [Semantic Search](#92-semantic-search)
   - 9.3 [Instruction-Aware Models (E5, BGE)](#93-instruction-aware-models-e5-bge)
   - 9.4 [Matryoshka Truncation](#94-matryoshka-truncation)
10. [The MTEB Benchmark: What It Measures and How](#10-the-mteb-benchmark-what-it-measures-and-how)
    - 10.1 [Retrieval (58 datasets, PRIMARY task)](#101-retrieval-58-datasets-primary-task)
    - 10.2 [Semantic Textual Similarity (STS)](#102-semantic-textual-similarity-sts)
    - 10.3 [Clustering](#103-clustering)
    - 10.4 [Classification](#104-classification)
    - 10.5 [Reranking](#105-reranking)
    - 10.6 [Pair Classification](#106-pair-classification)
    - 10.7 [Bitext Mining](#107-bitext-mining)
    - 10.8 [Summarization](#108-summarization)
    - 10.9 [BEIR: Zero-Shot Retrieval Benchmark](#109-beir-zero-shot-retrieval-benchmark)
11. [How to Choose the Right Model for Your Use Case](#11-how-to-choose-the-right-model-for-your-use-case)
12. [State-of-the-Art Embedding Models: Full Comparison](#12-state-of-the-art-embedding-models-full-comparison)
    - 12.1 [Open-Source Models](#121-open-source-models)
    - 12.2 [Closed-Source / API Models](#122-closed-source--api-models)
    - 12.3 [Choosing by Dimension vs Quality Trade-off](#123-choosing-by-dimension-vs-quality-trade-off)
    - 12.4 [Key Trends Across the Landscape](#124-key-trends-across-the-landscape)
13. [Putting It All Together: The Modern Recipe](#13-putting-it-all-together-the-modern-recipe)
