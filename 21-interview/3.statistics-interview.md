...
![Log-Normal vs Normal Distribution](log_normal_distribution.png)
...
![Correlation Formula — Cov(x,y) / σx·σy](Correlation-Formula.png)
...
![Z-Score formula and 68-95-99.7 bands](z-score.webp)
...
![Skewness — Positive, Symmetrical, Negative distributions](skewness_1.png)

![Right-Skewed distribution: Mode < Median < Mean](skewness_2.png)
...
![Standard Deviation Formula — Population (σ, divide by n) vs Sample (s, divide by n−1)](Standard-Deviation-Formula.png)
...
![Central Limit Theorem — any distribution's sample mean converges to normal for n > 30](central_limit_theorem.png)
...
![Interquartile Range — Q1 (25th), Median (50th), Q3 (75th) percentiles; IQR = Q3 − Q1](IQR.webp)
