...
**The core idea:** split users into two groups. Group A (control) sees the current recommender. Group B (treatment) sees the new one. Measure a business metric for each group and ask: is the difference larger than what random chance could explain?
