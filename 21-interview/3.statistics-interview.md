...
- [Q22: What is A/B testing and what are the most common pitfalls?](#q22-what-is-ab-testing-and-what-are-the-most-common-pitfalls)
...
## Q22: What is A/B testing and what are the most common pitfalls?
...
Current CTR (control / popularity model) = 21.0%. You want to detect a 2 percentage-point absolute lift (to 23.0%), α = 0.05, power = 0.80:

$$n = \frac{2(z_{\alpha/2} + z_\beta)^2 \cdot \bar{p}(1-\bar{p})}{\delta^2} = \frac{2(1.96 + 0.84)^2 \times 0.22 \times 0.78}{(0.02)^2} \approx 10{,}000 \text{ users per group}$$

Register this before starting. Do not peek at results until you reach 10,000 per group.
