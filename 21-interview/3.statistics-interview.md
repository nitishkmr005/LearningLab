...
- [Q19: What is hypothesis testing, and what is a p-value?](#q19-what-is-hypothesis-testing-and-what-is-a-p-value)
- [Q20: What is a confidence interval, and how do you interpret it correctly?](#q20-what-is-a-confidence-interval-and-how-do-you-interpret-it-correctly)
- [Q21: What is statistical power and how do you calculate the required sample size?](#q21-what-is-statistical-power-and-how-do-you-calculate-the-required-sample-size)
- [Q22: What is the Chi-square (χ²) test, and how is it used in ML?](#q22-what-is-the-chi-square-χ²-test-and-how-is-it-used-in-ml)
- [Q23: What statistical tests are used in ML, and when/how do you apply each?](#q23-what-statistical-tests-are-used-in-ml-and-whenhow-do-you-apply-each)

**Bayesian Statistics** — Bayes' Theorem · Bayesian Reasoning
- [Q24: What is Bayes' theorem, and when do you use Bayesian reasoning?](#q24-what-is-bayes-theorem-and-when-do-you-use-bayesian-reasoning)

**Experimentation** — A/B Testing · Pitfalls
- [Q25: What is A/B testing and what are the most common pitfalls?](#q25-what-is-ab-testing-and-what-are-the-most-common-pitfalls)
...
- [Q18: Statistics Tips, Tricks & Common Mistakes Across the Full ML Lifecycle](#q18-statistics-tips-tricks--common-mistakes-across-the-full-ml-lifecycle)
...
## Q19: What is hypothesis testing, and what is a p-value?
...
## Q20: What is a confidence interval, and how do you interpret it correctly?
...
## Q21: What is statistical power and how do you calculate the required sample size?
...
## Q22: What is the Chi-square (χ²) test, and how is it used in ML?
...
## Q23: What statistical tests are used in ML, and when/how do you apply each?
...
## Q24: What is Bayes' theorem, and when do you use Bayesian reasoning?
...
## Q25: What is A/B testing and what are the most common pitfalls?
...
**Scenario:** You built a new two-tower neural retrieval model and want to know if it beats the existing matrix factorization model on a music streaming platform.

**Step 1 — Define metrics before anything else**

| Type | Metric | Why |
|---|---|---|
| Primary (north star) | 7-day stream-start rate | Did users actually play songs from the recommendations? |
| Guardrail | Skip rate, session length | Make sure the new model doesn't harm experience |
| Diagnostic | Click-through rate per slot | Debug *where* the improvement comes from |

Never use offline NDCG as your primary metric — it frequently disagrees with online outcomes.
...
```
User 1234 always gets the same model across all sessions. Session-level assignment would mean the same user sees both models on different days — polluting both groups.

**Step 3 — Power analysis to set sample size**

Suppose current 7-day stream-start rate = 42%. You want to detect a 2 percentage-point lift (to 44%), with α = 0.05, power = 0.80:

$$n = \frac{2(z_{\alpha/2} + z_\beta)^2 \cdot p(1-p)}{\delta^2} = \frac{2(1.96 + 0.84)^2 \times 0.42 \times 0.58}{(0.02)^2} \approx 8{,}000 \text{ users per group}$$

You need ~8,000 users in each group — register this before starting. Do not look at results until you reach this count.

**Step 4 — Run for ≥ 2 weeks**

Short tests are corrupted by novelty effect (users click more just because the UI changed). Two weeks captures weekly seasonality and lets novelty wear off.

**Step 5 — Analyze with a two-proportion z-test**

| Group | Users | Stream starts | Rate |
|---|---|---|---|
| Control (MF model) | 8,200 | 3,444 | 42.0% |
| Treatment (two-tower) | 8,050 | 3,582 | 44.5% |

$$z = \frac{\hat{p}_T - \hat{p}_C}{\sqrt{\hat{p}(1-\hat{p})\left(\frac{1}{n_C}+\frac{1}{n_T}\right)}}$$

With $\hat{p} = (3444+3582)/(8200+8050) = 0.432$:

$$z = \frac{0.445 - 0.420}{\sqrt{0.432 \times 0.568 \times (1/8200 + 1/8050)}} \approx \frac{0.025}{0.0077} \approx 3.25$$

$p < 0.001$ — statistically significant. Ship the two-tower model. Also check guardrail metrics: if skip rate rose by 5%, dig in before shipping.
...
## Q18: Statistics Tips, Tricks & Common Mistakes Across the Full ML Lifecycle
