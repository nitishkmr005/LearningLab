...
**Unsupervised Algorithms** — Distance metrics · Dimensionality
...
**Tree-Based Algorithms** — Decision Trees · Random Forest · XGBoost / Gradient Boosting
...
- [Q28: Which scaler should you use — StandardScaler, MinMaxScaler, or RobustScaler?](#q28-which-scaler-should-you-use--standardscaler-minmaxscaler-or-robustscaler)
...
- [Q62: What is model drift, concept drift, and data drift — and how do you detect each in production?](#q62-what-is-model-drift-concept-drift-and-data-drift--and-how-do-you-detect-each-in-production)
...
# Example: subtle mean drift (training μ=100, production μ=106)
np.random.seed(42)
